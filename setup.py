...
# Include all .c and .pxd files, recursively, including those generated
# by Cython, since we can not do this in MANIFEST.in with a "dynamic"
# directory name.
compiled_files = []
...
package_info['package_data'][PACKAGENAME].extend(compiled_files)
